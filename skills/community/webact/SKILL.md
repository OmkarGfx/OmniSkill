...
| `unlock` | `webact unlock` |
| `uninstall` | `webact uninstall` |
| `mcp` | `webact mcp` (run as MCP server via stdio) |
| `clipboard <html\|text>` | `webact clipboard --html="<b>bold</b>" --text="bold"` |
